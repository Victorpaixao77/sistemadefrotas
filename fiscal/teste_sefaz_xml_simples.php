<?php
/**
 * 🧪 Teste SEFAZ - XML SOAP Simples
 * 📋 Testa com XML SOAP mais simples e correto
 */
...
<html>
<head>
    <title>Teste SEFAZ - XML SOAP Simples</title>
    <meta charset='utf-8'>
    <style>
...
<body>
    <div class='container'>
        <h1>🧪 Teste SEFAZ - XML SOAP Simples</h1>
        <p>Testa com XML SOAP mais simples e correto</p>";
...
try {
    ...
    echo "<div class='card'>
        <h3>🧪 Testando SEFAZ - XML SOAP Simples</h3>";
    
    // Lista de endpoints para testar com XML mais simples
    $endpoints = [
        [
            'nome' => 'NF-e Status (SVRS) - XML Simples',
...
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
    ...
    <soap:Body>
        ...
        [
            'nome' => 'NF-e Status (SVRS) - XML Básico',
            'url' => 'https://nfe-homologacao.svrs.rs.gov.br/ws/NfeStatusServico/NfeStatusServico4.asmx',
            'soap_action' => 'http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico4/nfeStatusServicoNF',
            'xml' => '<?xml version="1.0" encoding="UTF-8"?>
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
    <soap:Body>
        ...
        [
            'nome' => 'NF-e Status (SVRS) - Sem Namespace',
            'url' => 'https://nfe-homologacao.svrs.rs.gov.br/ws/NfeStatusServico/NfeStatusServico4.asmx',
            'soap_action' => 'http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico4/nfeStatusServicoNF',
            'xml' => '<?xml version="1.0" encoding="UTF-8"?>
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
