<?php
/**
 * 🧪 Teste SEFAZ - Endpoint Status Correto
 * 📋 Testa usando o endpoint específico para consulta de status
 */
...
<html>
<head>
    <title>Teste SEFAZ - Endpoint Status Correto</title>
    <meta charset='utf-8'>
    <style>
...
<body>
    <div class='container'>
        <h1>🧪 Teste SEFAZ - Endpoint Status Correto</h1>
        <p>Testa usando o endpoint específico para consulta de status</p>";
...
try {
    ...
    echo "<div class='card'>
        <h3>🧪 Testando SEFAZ - Endpoints de Status</h3>";
    
    // Lista de endpoints para testar
    $endpoints = [
        [
            'nome' => 'NF-e Status (SVRS)',
...
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" xmlns:nfe="http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico4">
    ...
    <soap:Body>
        ...
        [
            ...
            'xml' => '<?xml version="1.0" encoding="UTF-8"?>
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" xmlns:mdfe="http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeStatusServico">
    <soap:Header/>
    <soap:Body>
        <mdfe:mdfeDadosMsg>
